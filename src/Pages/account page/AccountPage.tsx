        ...
        <div className="account_page_body_cards">
          ...
          >
            <TextField
              ...
              inputRef={name}
              // onChange={(event) => {
              //   name = event.target.value as unknown as React.MutableRefObject<HTMLInputElement>
              //   console.log(name)
              // }}
          ...
          >
            <TextField
              ...
              inputRef={email}
              // onChange={(event) => {
              //   email = event.target.value as unknown as React.MutableRefObject<HTMLInputElement>
              //   console.log(email)
              // }}
              sx={{ width: "100%", borderRadius: "25px" }}
            />
                ...
                : <Card
                  ...
                  >
                    <TextField
                      ...
                      // onChange={(event) => {
                      //   original_password = event.target.value as unknown as React.MutableRefObject<HTMLInputElement | undefined>
                      //   console.log(name)
                      // }}
                      sx={{ width: "100%", borderRadius: "25px" }}
                    />
                ...
                : <Card
                  ...
                  >
                    <TextField
                      ...
                      inputRef={password}
                      // onChange={(event) => {
                      //   password = event.target.value as unknown as React.MutableRefObject<HTMLInputElement>
                      //   console.log(name)
                      // }}
                      sx={{ width: "100%", borderRadius: "25px" }}
                    />
                ...
                : <Card
                  ...
                  >
                    <TextField
                      ...
                      // onChange={(event) => {
                      //   confirm_password = event.target.value as unknown as React.MutableRefObject<HTMLInputElement>
                      //   console.log(name)
                      // }}
                      sx={{ width: "100%", borderRadius: "25px" }}
                    />
